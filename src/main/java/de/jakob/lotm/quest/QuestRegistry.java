...
import de.jakob.lotm.quest.impl.kill_beyonder_quests.KillAngelBeyonderQuest;
...
public class QuestRegistry {
    ...
    public static void init() {
        ...
        registerQuest(new KillAngelBeyonderQuest("kill_angel_beyonder", 3));
        registerQuest(new FindStructureQuest("find_random_structures", 8, 3));
